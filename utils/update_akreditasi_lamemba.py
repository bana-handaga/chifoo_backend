...
LAMEMBA_FILE  = os.path.join(BASE_DIR, "utils/ext/lamemba_prodi.json")
...
def main():
    with open(LAMEMBA_FILE, encoding="utf-8") as f:
        lamemba = json.load(f)

    idx = build_index(lamemba)
