...
LAMSAMA_FILE  = os.path.join(BASE_DIR, "utils/ext/lamsama_prodi.json")
...
def main():
    with open(LAMSAMA_FILE, encoding="utf-8") as f:
        lamsama = json.load(f)
    idx = build_index(lamsama)
