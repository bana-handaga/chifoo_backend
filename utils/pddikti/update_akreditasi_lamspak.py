...
LAMSPAK_FILE  = os.path.join(BASE_DIR, "utils/ext/lamspak_prodi.json")
...
def main():
    with open(LAMSPAK_FILE, encoding="utf-8") as f:
        lamspak = json.load(f)
    idx = build_index(lamspak)
